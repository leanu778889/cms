...
<link href="http://localhost/cms/templates/default/Public/css/details.css" rel="stylesheet" />
<link href="http://localhost/cms/templates/default/Public/css/common.css" rel="stylesheet" />
<script type="text/javascript" src="http://localhost/cms/templates/default/Public/js/index.js"></script>
</head>
<body>
	<?php if(!defined("HDPHP_PATH"))exit;C("SHOW_WARNING",false);?><script type='text/javascript' src='http://localhost/cms/hdphp/Extend/Org/Jquery/jquery-1.8.2.min.js'></script>
<link href="http://localhost/cms/templates/default/Public/css/head.css" rel="stylesheet" />
<script>
	// 验证码初始地址
	var codeSrc = '<?php echo U("Index/User/showCode");?>';
</script>
<script type="text/javascript" src="http://localhost/cms/templates/default/Public/js/head.js"></script>

<!-- 遮挡层 -->
<div id="cover"> </div>
<!-- 登录框 -->
<div id="loginBox" url="<?php echo U("Index/User/checkIsLogin");?>" app="http://localhost/cms/index.php/Index">
...
<div id="top">
		<div class='pos'>
			<div class='user' id="user">
				<img style="margin-top:10px;" id="loading" src="http://localhost/cms/templates/default/public/images/05043156.gif"/>
			</div>
			<div class='search'>
	...
	<div id="header">
		...
		<div class='navigation'>
			<a href="http://localhost/cms">首页</a>
					<?php
		$db = M('category');
		...
		<div id="main">
			...
			<div class='details'>
				<h1><?php echo $n['news']['title'];?></h1>
				<div class='info'>
					<div class='base'>
						<em>发表于<?php echo date('Y-m-d H:i:m',$news['addtime']);?></em>, 作者:<span><?php echo $news['author'];?></span>, 分类：<strong><a href="<?php echo $news['category_url'];?>"><?php echo $news['cname'];?></a></strong>
					</div>
					<div class='tag'>
						点击数:<span id="click" url="<?php echo U('Index/Detail/showClick');?>/id/<?php echo $news['id'];?>"><?php echo $news['click'];?></span>
					</div>
				</div>
				<div class='content'>
					<?php echo $news['body'];?>
				</div>
				<div id="comment" url="<?php echo U('Index/Detail/listComment');?>/news_id/<?php echo $news['id'];?>">
					<div class="showComment">
						<img style="margin-top:10px;" class="commentLoading" src="http://localhost/cms/templates/default/public/images/05043156.gif"/>
					</div>
					<div class='isLogin' style="display:none;">
						<form id="commentForm" action="<?php echo U('Index/Detail/addComment');?>" method="post">
					...
					<div class='notLogin' style="display:none;">
						请先 <a href="javascript:showLoginBox()" style="color:blue">登录</a> 在评论
					</div>
