...
<link href="http://localhost/cms/templates/default/Public/css/category.css" rel="stylesheet" />
...
<div id="main">
		<div class='news'>
			<?php if(is_array($news)):?><?php  foreach($news as $v){ ?>
				<div class='newsList'>
					<div class='newsImage'>
						<a href="<?php echo $v['url'];?>"><img src="http://localhost/cms/<?php echo $v['thumb'];?>"/></a>
					</div>
