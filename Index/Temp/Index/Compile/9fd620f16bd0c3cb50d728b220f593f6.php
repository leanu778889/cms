...
<link href="http://localhost/cms/templates/default/Public/css/index.css" rel="stylesheet" />
		...
		<div class='content'>
			<div  class='list'>
				...
				<ul>
							...
							<?php
			$db = K('news');
			$data = $db->fetchAll(" recycled=0","addtime DESC",9);
		?><?php foreach($data as $k=>$v):?>
					<li>
						<div class='post-image'>
							<span>
								<a href="<?php echo $v['url'];?>">
									<img width="180" src="<?php echo $v['thumb'];?>" />
								</a>
							</span>
						</div>
						<div class='post-content'>
							...
							<a class='more' href="<?php echo $v['url'];?>">更多>></a>
						</div>
					</li>
					<?php endforeach;?>
			...
			<div  class='list'>
				...
				<ul>
							<?php
			$db = K('news');
			$data = $db->fetchAll(" recycled=0","click DESC",9);
		?><?php foreach($data as $k=>$v):?>
					<li>
						<div class='post-image'>
							<span>
