...
<link href="http://localhost/11.11/templates/default/public/css/details.css" rel="stylesheet" />
			...
			<div class='details'>
				...
				<div id="comment" url="<?php echo U('Index/Detail/listComment');?>/news_id/<?php echo $news['id'];?>">
					<div class="showComment">
						<img style="margin-top:10px;" class="commentLoading" src="http://localhost/11.11/templates/default/public/images/05043156.gif"/>
					</div>
