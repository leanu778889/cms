		...
		<table class='table table-bordered'>
			...
			<?php if(is_array($data)):?><?php  foreach($data as $v){ ?>
				<tr>
					...
					<td>
						<a class='btn btn-small' href="<?php echo U('News/recycle');?>/id/<?php echo $v['id'];?>/value/0">还原</a>
						<br/>
						<br/>
						<a class='btn btn-small delAffirm' href="<?php echo U('News/del');?>/id/<?php echo $v['id'];?>">彻底删除</a>
					</td>
				</tr>
			<?php }?><?php endif;?>
			</tbody>
