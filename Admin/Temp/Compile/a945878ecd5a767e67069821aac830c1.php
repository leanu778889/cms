...
<link href="http://localhost/cms/hdphp/Extend/Org/HdUi/css/hdui.css" rel="stylesheet" media="screen"><script src="http://localhost/cms/hdphp/Extend/Org/HdUi/js/hdui.js"></script>
<body>
<div id="window">
	<div class='page_title'>
		<strong>添加分类</strong>
	</div>
		<form action="http://localhost/cms/admin.php/Category/add"  method="post">
